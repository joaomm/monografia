...
como Robert C. Martin \citep{Martin2008} e Kent Beck \citep{Beck2007}. Baseado em testes e decisões técnicas que visam a clareza, flexibilidade
...
Deste modo, queremos apresentar uma maneira de utilizar o poder da automatização das métricas associado a interpretação dos valores calculados, facilitando assim a aproximação para com os conceitos relacionados com código limpo.
