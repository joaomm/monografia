...
\lstinputlisting[label=envy, caption={Método salario() é muito acoplado a classe Empregado sem violar a Lei de Demeter}]{codigos/train_wreck}
...
\caption{Técnicas: descrição, contribuições e consequências}
\scalefont{1}
\end{table}
