...
%
Os seguintes livros são base para os nossos estudos: Clean Code de Robert Martin e Implementation Patterns de Kent Beck.
Todos possuem diversos aspectos que ajudam a identificar o que é um código limpo como escolhas de bons nomes, ausência de
duplicações, organização e simplicidade. Esta monografia conterá uma reunião de todos esses, explicitando sua relevância e aplicação.
%
...
do trabalho, além de contribuir diretamente com melhorias para o código da aplicação.
