...
%para ajudar na formatação de códigos
\usepackage{float}      
\usepackage{fancyvrb}
...
Os seguintes livros são base para os nossos estudos: Clean Code de Robert Martin, Implementation Patterns de Kent Beck e, possivelmente Code Complete de Steve McConnell. Todos possuem diversos aspectos que ajudam a identificar o que é um código limpo como escolhas de bons nomes, falta de duplicações, organização e simplicidade. Esta monografia conterá uma reunião de todos esses, explicitando sua relevância e aplicação.
%
